    ...
    <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[color:rgba(9,17,28,0.82)] backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1360px] items-center justify-between gap-6 px-6 py-4 lg:px-10">
        ...
        <div className="flex items-center gap-3 md:gap-5">
          ...
          <a
            href={downloadUrl}
            className={`inline-flex items-center justify-center rounded-full border border-[var(--border-strong)] bg-[var(--accent)] px-4 py-2 text-sm font-medium text-[var(--bg-deep)] transition-transform hover:-translate-y-0.5 ${downloadMinWidthClassName}`}
          >
            Download
          </a>
        </div>
